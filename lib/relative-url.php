 ...
 */
function wpreboot_root_relative_url($input) {
...
if (wpreboot_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'wpreboot_root_relative_url');
}
